...
import pytest
from source_iusta.source import IustaStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(IustaStream, "path", "v0/example_endpoint")
    mocker.patch.object(IustaStream, "primary_key", "test_primary_key")
    mocker.patch.object(IustaStream, "__abstractmethods__", set())
